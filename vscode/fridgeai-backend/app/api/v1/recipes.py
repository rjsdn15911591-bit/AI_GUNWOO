...
- nutrition 추정 방법: 재료별 실제 사용 중량(g)과 표준 식품영양성분표(식약처 기준)를 바탕으로 protein·carbs·fat을 먼저 계산 후, calories는 반드시 protein×4 + carbs×4 + fat×9 공식으로 산출 (칼로리 독립 추정 절대 금지)
- 조리 과정의 수분 증발·지방 유출 등 조리 손실을 고려해 최종 영양소를 현실적으로 조정
